...
import { CommentType, ContentCardType, UserType } from "@/_types/post"
import { generateRandomDescription } from "./random_kr"

export const dummyContentCards: ContentCardType[] = Array.from({ length: 10 }, (_, index) => ({
  title: `Card ${index + 1}`,
...
export const candidates = [
  ...
  },
  {
    number: 5,
    listId: "5ggg",
    image_src: "https://blog.kakaocdn.net/dn/WGp8A/btqD1NJN902/lkK4e34JIBVG5VsrczH3h1/img.jpg",
    title: "츠유리 카나오",
    description: `약학에 정통해서 주들 중에서 유일하게 독을 사용하여 도깨비를 죽인다. 귀살대 내에서 의료장교 역할을 하고 있으며 자신의 거처인 '나비저택'을 병동으로 사용하고 있다. 이 저택에는 각각 귀살대원은 아니지만 키요, 스미, 나호라는 아이들이 저택 사용인 겸 간호사로 일하고 있다. 귀살대 대원 중에서는 칸자키 아오이와 자신의 츠구코인 츠유리 카나오가 직속 부하로서 일하고 있다.`,
    count: 9,
  },
